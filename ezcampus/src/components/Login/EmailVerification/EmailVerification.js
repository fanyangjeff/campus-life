    ...
    handlerEmailInfo = (event) => {
        ...
        if (isChangePassword) {
            if (Password !== RetypePassword) {
                ...
                axios.post("https://server.metaraw.world:3000/users/forget_password/reset_password", {
                    "codeEmail":codeEmail,
                    "password":Password,
                    }
                )
            ...
            if (isEnterCode) {
                ...
                axios.get("https://server.metaraw.world:3000/users/forget_password/verify", {params: {code, codeEmail}})
                    .then(res => {
                        if (res.data.statusCode === 200) {
                ...
                axios.get("https://server.metaraw.world:3000/users/forget_password/send_email", {params: {email}})
                    .then(res => {
                        if (res.data.statusCode === 200) {
                            this.setState({
                                    isEnterCode: true,
